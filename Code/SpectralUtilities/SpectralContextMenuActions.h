...
/**
 *  Flag to clear existing results before adding new results.
 */
#define SPECTRAL_LIBRARY_MATCH_RESULTS_AUTOCLEAR_ACTION "SPECTRAL_LIBRARY_MATCH_RESULTS_AUTOCLEAR_ACTION"
