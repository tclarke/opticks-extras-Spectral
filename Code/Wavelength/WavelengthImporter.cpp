...
{
   StepResource pStep(string("Execute ") + getName(), "Spectral", "5675693B-AC25-4C98-9924-ED4E17DC1C30");
   if (pInArgList == NULL)
   {
   ...
   bool bSuccess = loadWavelengths(wavelengths, errorMessage);
   if (bSuccess == false)
   {
   ...
   Wavelengths::WavelengthUnitsType units = wavelengths.getUnits();
